<template>
	...
	>
		<b-row>
			<b-col>
				<b-button v-b-modal="`modalAdd-${type}`" :variant='"primary"' :block='true'>
				...
				>
			    	...
			    	<b-form-input id='inputName' v-model="name" :placeholder="`Create a new ${type}`"></b-form-input>
			    	...
			    	<label v-if="type === 'place'" for='selectShifts'>Select the shifts</label>
			    	<b-row v-if="type === 'place'" id='selectShifts'>
			    		<b-col cols='3' class='text-center'>
			    			...
			    			><small v-if='morningSelected' class='fas fa-check text-success'></small></i>
			    			<br />
			    			<small>Morning</small>
			    		</b-col>
			    		<b-col class='text-center' cols='3'>
			    			...
			    			><small v-if='afternoonSelected' class='fas fa-check text-success'></small></i>
			    			<br />
			    		...
			    		<b-col class='text-center' cols='3'>
			    			...
			    			><small v-if='eveningSelected' class='fas fa-check text-success'></small></i>
			    			<br />
			    			<small>Evening</small>
			    		</b-col>
			    		<b-col class='text-center' cols='3'>
			    			...
			    			><small v-if='dawnSelected' class='fas fa-check text-success'></small></i>
			    			<br />
			    			<small>Dawn</small>
			    		</b-col>
			    	</b-row>
