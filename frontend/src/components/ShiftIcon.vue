...
export default {
  ...
  methods:{
    ...
    getTooltipText(){
        return this.isPending ? `Click to schedule a vigilant to ${this.reference.toLowerCase()}` : `${this.getNameOfAVigilantByID(this.shift.vigilantID)} is scheduled in ${this.reference.toLowerCase()}`
    },
    isNigth(ref){
